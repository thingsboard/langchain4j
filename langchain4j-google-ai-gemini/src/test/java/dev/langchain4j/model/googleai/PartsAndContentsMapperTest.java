...
class PartsAndContentsMapperTest {
    ...
    void fromMessageToGContent_preservesToolExecutionRequestId() {
        ...
        // When
        List<GeminiContent> result = PartsAndContentsMapper.fromMessageToGContent(List.of(aiMessage), null, false, false);
    ...
    void fromMessageToGContent_preservesToolExecutionResultId() {
        ...
        List<GeminiContent> result =
                PartsAndContentsMapper.fromMessageToGContent(List.of(toolExecutionResultMessage), null, false, false);
